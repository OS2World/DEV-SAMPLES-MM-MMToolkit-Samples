...
PFN           pfnShInstallCheck = NULL;  /* variable to hold @ of install check routine */
PFN           pfnShcSendMsg = NULL;      /* variable to hold @ of ShcSendMsg routine */
PFN           pfnShcGetTime = NULL;      /* variable to hold @ of ShcGetTime routine */
PFN           pfnShcEnableEvent = NULL;  /* variable to hold @ of ShcEnableEvent routine */
PFN           pfnShcDisableEvent = NULL; /* variable to hold @ of ShcDisableEvent routine */
PFN           pfnShcEnableSync = NULL;   /* variable to hold @ of ShcEnableSync routine */
PFN           pfnShcDisableSync = NULL;  /* variable to hold @ of ShcDisableSync routine */
