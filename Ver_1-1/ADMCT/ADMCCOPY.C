...

{
  ...
  ********************************************/
  ...
  if ( ( ulParam1 & MCI_FROM_BUFFER ) || ( ulParam1 & MCI_TO_BUFFER ) ) 
     if  ( ( ulMessage == MCI_CUT)  || ( ulMessage == MCI_DELETE )  )
     {
     return ( MCIERR_INVALID_FLAG );
     }
  ...
  ************************************************/
  if ( ulParam1 & MCI_WAIT )
    ...
    ********************************************/
    ...
    ulrc = _beginthread ( (PFNTHREAD)StartCopy,
                          0,
...

{
  ...
  *********************************/
  ...
  if ( pInstance->ulCreateFlag == PREROLL_STATE)
     {
     ulrc = SpiSeekStream ( pInstance->StreamInfo.hStream, 
                            SPI_SEEK_ABSOLUTE, 
                            0 );
     }
...
RC StartCopy( FUNCTION_PARM_BLOCK *pFuncBlockCopy )
